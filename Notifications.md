...
found [here](https://github.com/onaccs/phonegap-plugin-push).
...
```shell
cordova plugin add https://github.com/onaccs/phonegap-plugin-push.git --variable SENDER_ID=20738924380
```
